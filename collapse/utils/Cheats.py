...
fluger_old = Cheat('Fluger (old)', data.get_url('Fluger-old.zip'), internal=True, main_class='Start')
fluger_new = Cheat('Fluger (new)', data.get_url('Fluger-new.jar'), version='1.16')
fougest_beta = Cheat('Fougest (Beta)', data.get_url('Fougest.jar'), version='1.16')
