...
parser.add_argument(
    "--disable-analytics", action="store_true", help="Disable analytics"
)
parser.add_argument(
    "--disable-updater", action="store_true", help="Disable update check"
)
...
parser.add_argument(
    "--server-debug", action="store_true", help="Enable debug mode for SDK server"
)
parser.add_argument(
    "--no-logs", action="store_true", help="Disable logs for SDK server"
)
