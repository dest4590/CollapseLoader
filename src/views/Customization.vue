                ...
                <div class="flex flex-col gap-4 max-w-md">
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label
                                class="text-sm font-medium text-base-content"
                                >{{ t("customization.spotlight_blur") }}</label
                            >
                            <div class="flex items-center gap-2">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label
                                class="text-sm font-medium text-base-content"
                                >{{ t("customization.history_blur") }}</label
                            >
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-base-content/60"
                                    >{{ historyBlur }}px</span
                                ...
                                <button
                                    class="btn btn-ghost btn-xs opacity-50 hover:opacity-100"
                                    @click="
                                        handlePanelBlurInput('historyBlur', 20)
                                    "
                                >
                                    <RotateCcw class="w-3 h-3" />
                                </button>
                        ...
                        <div class="flex flex-col gap-2 mb-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <span
                                    ...
                                    "
                                    @click="
                                        addExample('.launch-btn, .download-btn')
                                    "
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                >
                                    <div class="card-body p-4">
                                        ...
                                        <button
                                            @click="insertExample(example.code)"
        ...
        >
            <div class="card-body">
                <h2 class="card-title flex items-center gap-2 mb-2">
                    ...
                    {{ t("theme.client_card_preview.title") }}
                </h2>
                <p class="text-sm text-base-content/60 mb-4">
                    {{ t("theme.client_card_preview.description") }}
                </p>
                ...
                <div class="flex flex-row gap-6 items-start">
                    <div class="w-[420px] shrink-0">
                        <ClientCard
                            :client="mockClient"
                            :isClientRunning="previewRunning"
                            :isClientInstalling="previewInstalling"
                            :isRequirementsInProgress="previewRequirements"
                    ...
                    <div class="flex-1 flex flex-col gap-5 min-w-0">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" class="toggle toggle-primary toggle-sm" v-model="previewRunning" />
                                    <span class="text-sm">{{ t("theme.client_card_preview.controls.running") }}</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" class="toggle toggle-primary toggle-sm" v-model="previewInstalling" />
                                    <span class="text-sm">{{ t("theme.client_card_preview.controls.installing") }}</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" class="toggle toggle-primary toggle-sm" v-model="previewRequirements" />
                                    <span class="text-sm">{{ t("theme.client_card_preview.controls.requirements") }}</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" class="toggle toggle-primary toggle-sm" v-model="previewFavorite" />
                                    <span class="text-sm">{{ t("theme.client_card_preview.controls.favorite") }}</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" class="toggle toggle-primary toggle-sm" v-model="previewSelected" />
                                    <span class="text-sm">{{ t("theme.client_card_preview.controls.selected") }}</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 class="text-xs font-bold uppercase tracking-widest opacity-60 mb-2">
                                {{ t("theme.ui_preview.buttons") }}
                            </h3>
                            <div class="flex flex-wrap gap-2">
                                <button class="btn btn-primary btn-sm">{{ t("theme.ui_preview.primary") }}</button>
                                <button class="btn btn-secondary btn-sm">{{ t("theme.ui_preview.secondary") }}</button>
                                <button class="btn btn-accent btn-sm">{{ t("theme.ui_preview.accent") }}</button>
                                <button class="btn btn-ghost btn-sm">{{ t("theme.ui_preview.ghost") }}</button>
                                <button class="btn btn-outline btn-sm">{{ t("theme.ui_preview.outline") }}</button>
                                <button class="btn btn-success btn-sm">{{ t("theme.ui_preview.success") }}</button>
                                <button class="btn btn-warning btn-sm">{{ t("theme.ui_preview.warning") }}</button>
                                <button class="btn btn-error btn-sm">{{ t("theme.ui_preview.error") }}</button>
                                <button class="btn btn-info btn-sm">{{ t("theme.ui_preview.info") }}</button>
                                <button class="btn btn-neutral btn-sm">{{ t("theme.ui_preview.neutral") }}</button>
                            </div>
                            <div class="flex flex-wrap gap-2 mt-2">
                                <button class="btn btn-primary btn-sm gap-1"><Download class="w-3.5 h-3.5" /> {{ t("theme.ui_preview.with_icon") }}</button>
                                <button class="btn btn-error btn-sm gap-1"><Trash2 class="w-3.5 h-3.5" /> {{ t("theme.ui_preview.delete") }}</button>
                                <button class="btn btn-success btn-sm gap-1"><Check class="w-3.5 h-3.5" /> {{ t("theme.ui_preview.confirm") }}</button>
                                <button class="btn btn-ghost btn-sm btn-circle"><Star class="w-4 h-4" /></button>
                                <button class="btn btn-outline btn-sm btn-circle"><Search class="w-4 h-4" /></button>
                                <button class="btn btn-disabled btn-sm">{{ t("theme.ui_preview.disabled") }}</button>
                            </div>
                        </div>
                        ...
                        <div>
                            <h3 class="text-xs font-bold uppercase tracking-widest opacity-60 mb-2">
                                {{ t("theme.ui_preview.forms") }}
                            </h3>
                            <div class="flex flex-wrap items-center gap-3">
                                <input type="text" :placeholder="t('theme.ui_preview.input_placeholder')" class="input input-bordered input-sm w-48" />
                                <select class="select select-bordered select-sm w-36">
                                    <option disabled selected>{{ t("theme.ui_preview.select_label") }}</option>
                        ...
                        <div>
                            <h3 class="text-xs font-bold uppercase tracking-widest opacity-60 mb-2">
                                {{ t("theme.ui_preview.badges") }}
                            </h3>
                            <div class="flex flex-wrap gap-2">
                                <span class="badge badge-primary badge-sm">{{ t("theme.ui_preview.primary") }}</span>
                                <span class="badge badge-secondary badge-sm">{{ t("theme.ui_preview.secondary") }}</span>
                                <span class="badge badge-accent badge-sm">{{ t("theme.ui_preview.accent") }}</span>
                                <span class="badge badge-success badge-sm">{{ t("theme.ui_preview.success") }}</span>
                                <span class="badge badge-warning badge-sm">{{ t("theme.ui_preview.warning") }}</span>
                                <span class="badge badge-error badge-sm">{{ t("theme.ui_preview.error") }}</span>
                                <span class="badge badge-info badge-sm">{{ t("theme.ui_preview.info") }}</span>
                                <span class="badge badge-ghost badge-sm">{{ t("theme.ui_preview.ghost") }}</span>
                                <span class="badge badge-outline badge-sm">{{ t("theme.ui_preview.outline") }}</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-2">
                                <div class="alert alert-success py-2 text-sm cursor-pointer hover:brightness-110 transition-all" @click="triggerNotification('success')"><CheckCircle class="w-4 h-4 shrink-0" /> {{ t("theme.ui_preview.alert_success") }}</div>
                                <div class="alert alert-error py-2 text-sm cursor-pointer hover:brightness-110 transition-all" @click="triggerNotification('error')"><XCircle class="w-4 h-4 shrink-0" /> {{ t("theme.ui_preview.alert_error") }}</div>
                                <div class="alert alert-warning py-2 text-sm cursor-pointer hover:brightness-110 transition-all" @click="triggerNotification('warning')"><AlertTriangle class="w-4 h-4 shrink-0" /> {{ t("theme.ui_preview.alert_warning") }}</div>
                                <div class="alert alert-info py-2 text-sm cursor-pointer hover:brightness-110 transition-all" @click="triggerNotification('info')"><Info class="w-4 h-4 shrink-0" /> {{ t("theme.ui_preview.alert_info") }}</div>
                            </div>
                        </div>
...
const previewRequirements = ref(false);
const previewFavorite = ref(false);
const previewSelected = ref(false);
