            ...
            >
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-3 mt-1">
                        <div
                            class="flex-1 bg-base-content/10 rounded-full h-1.5"
                        >
                            <div
                                class="bg-primary h-1.5 rounded-full transition-all"
                                :style="{
                                    width:
                                        getPercent(stats.playtimeMinutes) + '%',
                                }"
                            ></div>
                        </div>
...
import { Timer, Gamepad2 } from "@lucide/vue";
...
const entries = computed(() =>
    Object.entries(stats.value.clientStats).sort(
